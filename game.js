...
function ensureLocalAccountRecord(username, password = "", options = null) {
  ...
  const passwordHash = password && setPasswordOnCreate ? hashAccountPassword(normalizedName, password) : "";
  ...
  } else if (password && setPasswordOnExisting) {
